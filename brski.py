...
#             sleep(10)
#             threading.Thread(target=neg_with_pledge, args=[registrar_tagged,ipaddress.IPv6Address(list(tmp_answer['MAP'].keys())[0]),tmp_answer['PORTS']['registrar']]).start()
#         else:
...
def listen_handler(_tagged, _handle, _answer):
    ...
    try:
        ...
        mprint("\033[1;31;1m exception in listen_handler {} \033[0m".format(err), 2)
